                ...
                'profile',
                {
                    ...
                    'connection' : {
                        ...
                        'http://' : {
                            ...
                            endpoint : 'http://192.168.240.2:8890/sparql',
                            proxy : 'http://192.168.240.2:8890/sparql',
//                			endpointType : 'sesame',
                            sparql : {
                            ...
                            examples : [ {
                                label : 'samm:Practice',
                                uri : 'https://owaspsamm.org/model/Practice'
                            }, {
                    ...
                    'default' : {
                        ...
                        images : {
                            ...
                            'http://xmlns.com/foaf/0.1/depiction', 'http://dbpedia.org/ontology/thumbnail',
...
$.jStorage.set('doStats', $.jStorage.get('doStats', false));
